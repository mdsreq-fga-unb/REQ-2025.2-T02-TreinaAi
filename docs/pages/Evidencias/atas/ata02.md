...
**Horário:** 21:00  
**Local:** Google Meets  
**Participantes:** Gabriel, Davi, João, Raissa, Arthur, Jorge, Gustavo (cliente)
...
### 2. Definição Inicial do Escopo

- Esclarecimento de quais funcionalidades são essenciais para a primeira versão do sistema.  
- Discussão sobre possíveis etapas de evolução do produto ao longo do desenvolvimento.

---

### 3. Organização das Informações

- Todos os requisitos coletados serão organizados pela equipe para validação.  
- Será criada uma estrutura preliminar do sistema com base no levantamento.
...
|------------|--------|-------------------------|--------------------------|
| 29/09/2025 | 1.0    | Criação do Documento    | Arthur Gomes Oliveira    |
